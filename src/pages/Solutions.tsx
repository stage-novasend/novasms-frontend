...
import { ShoppingBag, GraduationCap, Stethoscope, Building2, Utensils, TrendingUp } from 'lucide-react';
  ...
  const sectors = [
    {
      ...
      useCases: ["Promotions flash", "Relance panier", "Fidélisation clients", "Nouveautés produits"]
    },
    {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-on-surface-variant leading-relaxed">
              Que vous soyez e-commerce, santé, éducation ou services, NovaSMS s'adapte à vos besoins spécifiques.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {sectors.map((sector, i) => (
              ...
              >
                ...
                <h3 className="font-headline text-3xl font-bold text-secondary mb-4">{sector.title}</h3>
                <p className="text-on-surface-variant leading-relaxed mb-8 text-lg">{sector.desc}</p>
                ...
                <div className="space-y-3">
                  <p className="text-sm font-bold text-secondary/60 uppercase tracking-wider">Cas d'usage</p>
                  <div className="flex flex-wrap gap-2">
                    {sector.useCases.map((useCase, idx) => (
                      <span key={idx} className="px-4 py-2 bg-primary/5 text-primary text-sm font-semibold rounded-lg border border-primary/20">
                        {useCase}
                      </span>
                    ))}
                  </div>
          ...
          >
            ...
            <p className="text-lg text-on-surface-variant mb-10 max-w-2xl mx-auto">
              Contactez-nous pour discuter de vos besoins spécifiques. Nous avons probablement déjà une solution pour vous.
            </p>
            <button 

  ...
  return (
    <aside className={`sidebar ${collapsed ? 'collapsed' : ''}`}>
      <div className="sb-logo">
        ...
        {!collapsed && <span style={{ fontSize: 14, fontWeight: 700, color: 'var(--text-1)' }}>NovaSMS</span>}
        <button
          type="button"
      ...
      <div className="sb-nav">
        ...
        <Item to="/dashboard" icon={<DashboardIcon />} label="Tableau de bord" collapsed={collapsed} />
        <Item to="/contacts" icon={<ContactsIcon />} label="Contacts" badge="12k" collapsed={collapsed} />
        <Item to="/campaigns" icon={<CampaignsIcon />} label="Campagnes" collapsed={collapsed} />
        <Item to="/automations" icon={<AutomationsIcon />} label="Automatisations" badge="3" collapsed={collapsed} />
        ...
        <Item to="/account/security" icon={<SecurityIcon />} label="Sécurité" collapsed={collapsed} />
        <Item to="/account/team" icon={<TeamIcon />} label="Équipe" collapsed={collapsed} />
        <Item to="/account/settings" icon={<SettingsIcon />} label="Paramètres" collapsed={collapsed} />
      </div>
